    ...
    return inquirer.prompt([
        {
            ...
            choices: ['View All Employees', 'View All Employees By Department', 'View All Employees By Manager', 'View Total Utilized Budget By Department', 'Add An Employee', 'Remove An Employee', "Update An Employee's Role", "Update An Employee's Manager", 'View All Departments', 'Add A Department', 'Delete A Department', 'View All Roles', 'Add A Role', 'Delete A Role', 'Exit']
        }
    ])
        .then(selection => {
            switch (selection.menu) {
                ...
                case 'Remove An Employee':
                    ...
                    // use that information to get the id of the selected employee with fetch
                    // pass the employee id through the delete route
                ...
                case "Update An Employee's Role":
                    ...
                    // create an empty employee object and add that id to the object
                    // present user with list of roles to select
                    // take that role, use fetch to get the ID and then add it to the employee object
                    // pass employee object to the put route to update role
                    break;
                ...
                // take the selection and get the ID
                // pass the ID to a delete fetch
            }
